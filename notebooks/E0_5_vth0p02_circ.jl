...
CSV.write("frame_E0_0p32_vth0p17_circ.csv",thdiag.data)
save("electric_E0_p32_vth0p17.jld2", "electric", electric)
save("s0_1.jld2", "s0_1", s0_1)
save("s0_2.jld2", "s0_2", s0_2)
save("s0_3.jld2", "s0_2", s0_3)
...
save("s10_1.jld2", "s10_1", s10_1)
save("s10_2.jld2", "s10_2", s10_2)
save("s10_3.jld2", "s10_3", s10_3)
save("s12_1.jld2", "s12_1", s12_1)
save("s12_2.jld2", "s12_2", s12_2)
save("s12_3.jld2", "s12_3", s12_3)
save("s20_1.jld2", "s20_1", s20_1)
save("s20_2.jld2", "s20_2", s20_2)
save("s20_3.jld2", "s20_3", s20_3)
save("s30_1.jld2", "s30_1", s30_1)
save("s30_2.jld2", "s30_2", s30_2)
save("s30_3.jld2", "s30_3", s30_3)
