...
@showprogress 1 for j = 1:steps # loop over time
	...
	if j == 2800  
        global s14_1 = vcat([get_s1(particle_group, i) for i in 1:n_particles]...)
        global s14_2 = vcat([get_s2(particle_group, i) for i in 1:n_particles]...)
        global s14_3 = vcat([get_s3(particle_group, i) for i in 1:n_particles]...)
        end 
end
